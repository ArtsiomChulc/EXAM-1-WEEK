...
//     100: {id: 100, likesCount: 0},
// }
// const newState = reducer(state, addTrackAC(300)) ///////==YES?????====//////
...
// }
//
// const deleteTrackAC =(trackId: number) =>({type: 'TRACK-DELETED', trackId}) //////===YES!!!!!!====/////////
//
//
// const state = [
//     {id: 12, likesCount: 10},
...
//             return {...state, user: {...state.user, name: action.name}}     ////////////////////=========YES?????=========////////////
//
//         default:
//             return state
//     }
...
//             return {
//                 ...state,
//                 volume: action.volumeLevel //////====xxxxxxYES====///////
//             }
//         default:
//             return state
//     }
...
//     switch (action.type) {
//         case 'TRACK-DELETED':
//             return state.filter((track: any) => track.id !== action.trackId) /////======xxxx==NO=======////
//         default:
//             return state
//     }
// }
...
// const Users = () => {
//
//     const users = useSelector(selector) /////=======xxxxYES=====////
//
//     return <ul>
//         {users.map(u => <li key={u.id}>{u.name}</li>)}
//     </ul>
...
//     const resetTemp = useCallback(() => setTemp(0), [])
//
//     const incSec = useCallback(() => setSeconds(seconds + 1), [seconds]) /////===seconds===//// YES
//
//     return <>
//         <TempDisplay temp={temp} resetTemp={resetTemp}/>
//         <SecDisplay seconds={seconds} incSec={incSec}/>
...
//
//     const correctButtons = useMemo(() => {
//         return buttons.filter(b => isAdmin ? true : !b.forAdminOnly)  //////=====useMemo isAdmin======//////
//     }, [isAdmin])
//
//     return <>
//         <ButtonsPanel buttons={correctButtons}/>
...
//     switch (action.type) {
//         case 'USER-NAME-UPDATED':
//             return {...state, user: {...state.user, name: action.name}}   /////======{...state, user: {...state.user, name: action.name}}=====//////
//
//         default:
//             return state
//     }
...
//
// function Counter() {
//     const [value, setValue] = useReducer(changeCounter, 0)  /////========useReducer======////
//     const [isCounter, setIsCounter] = useState(true)  /////========useState======////
//     const commonStyles: React.CSSProperties = {
//         border: "1px solid black",
//         margin: "100px auto",
//         width: "300px",
